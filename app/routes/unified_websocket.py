...
async def handle_text_detection(websocket: WebSocket, data: dict, state: dict):
    ...
    # Build full text from current frame
    ...
    response = {
        "text_string": text_to_send,  # Frontend looks for this field
    ...
    print(f"[Unified WS] Text Detection: stable={stable_text} | full={full_text} | sending='{text_to_send}'")
